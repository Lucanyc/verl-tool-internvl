...
class AgentActorConfig:
    ...
    enable_mtrl: bool=True
    mtrl_role: str="function"
    mtrl_sep: str=None # "\n<|im_start|>system\n{obs}<|im_end|>\n<|im_start|>assistant\n"
    ...
    #Reasoning prompt configuration for tool outputs
    add_reasoning_prompt: bool = False  # Whether to add reasoning prompt after tool returns
    #reasoning_prompt_template: str = """After receiving tool results: You FIRST need to think about the reasoning process step by step as an internal monologue by combining the TOOL OUTPUT with your own reasoning, and then provide the final answer.
